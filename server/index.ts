  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are an AI research assistant specializing in automation and workflow optimization. Your task is to provide detailed, practical information about automating processes and creating efficient workflows."
        },
        {
          role: "user",
          content: `Research request: ${query}\n\nPlease provide:\n1. Detailed analysis of automation possibilities\n2. Step-by-step implementation guide\n3. Best practices and considerations\n4. Potential challenges and solutions`
        }
      ],
      temperature: 0.7,
      max_tokens: 2000
    ...
    // 3. If no n8n workflows, try Make.com
    ...
    // 4. If still no workflows, add a placeholder
    if (automationWorkflows.length === 0) {
      automationWorkflows = [{
        title: "Basic Automation Template",
        description: "A starting point for your automation needs",
        url: "https://n8n.io/workflows/templates"
      }];
    }
    ...
    return {
      ...
      research: {
        ...
        sources: ["OpenAI GPT-4", "n8n Documentation", "Make.com API"]
      },
      premium_service: {
        title: "Professional Automation Setup",
        description: "Get expert help implementing your automation workflow",
        price: "$99",
        button: "Schedule Consultation"
      },
      n8n_workflow: {
        json: automationWorkflows[0] || {},
        explanation: "Basic workflow structure to get started",
